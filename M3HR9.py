...
browser.addheaders = [('user-agent','Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36')]
...
def sendtextconvo(comment): 
     ...
     print(">> 9N9ND M3HR9 K1NG >>> :: ", yyy+ ' ' +line, "\n") 

print("\033[1;33;40m", end = "") 
os.system('clear') 
print(logo) 
sp("\033[1m\033[36m[+] EM9IL D9L 9UR M3HR9 P9P9 BOL \n") 
print(47*'\33[1;36m-') 
